...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout iconContainer, @NonNull TextView tvIcon, @NonNull TextView tvMessage,
      @NonNull TextView tvTime, @NonNull TextView tvTitle, @NonNull View unreadDot) {
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNotificationBinding((LinearLayout) rootView, iconContainer, tvIcon, tvMessage,
          tvTime, tvTitle, unreadDot);
    }
