...
public final class ItemHistoryBinding implements ViewBinding {
  ...
  private ItemHistoryBinding(@NonNull CardView rootView, @NonNull TextView tvItems,
      @NonNull TextView tvOrderDate, @NonNull TextView tvOrderId, @NonNull TextView tvStatus,
  ...
  public static ItemHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemHistoryBinding((CardView) rootView, tvItems, tvOrderDate, tvOrderId, tvStatus,
          tvTotal);
    }
