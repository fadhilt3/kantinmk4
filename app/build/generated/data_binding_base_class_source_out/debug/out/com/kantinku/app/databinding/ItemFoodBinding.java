...
public final class ItemFoodBinding implements ViewBinding {
  ...
  private ItemFoodBinding(@NonNull CardView rootView, @NonNull TextView btnAdd,
  ...
  public static ItemFoodBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFoodBinding((CardView) rootView, btnAdd, tvEmoji, tvKantin, tvName, tvPrice);
    }
