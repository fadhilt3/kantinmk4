...
public final class ItemFoodPopularBinding implements ViewBinding {
  @NonNull
  ...
  public static ItemFoodPopularBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_food_popular, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemFoodPopularBinding bind(@NonNull View rootView) {
